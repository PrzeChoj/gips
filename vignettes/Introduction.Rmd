...
1. To learn more about the avaiable optimizers in `find_MAP()` and how to use those, see `vignette("Optimizers")` or the [pkgdown page](https://przechoj.github.io/gips/articles/Optimizers.html).
