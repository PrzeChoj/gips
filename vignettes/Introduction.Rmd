...
This package provides a way to find a *reasonable* permutation to be used as constraint in covariance matrix estimation. In this case *reasonable* means such, that maximizes the Bayesian posterior distribution when using Wishart disribution on symmetric, positive definite matrices as a prior. The idea, exact formulas and algorithm sketch are a contribution of PAPER.
