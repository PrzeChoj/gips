...
The theory derived in [1] is for general group invariance, while in this paper, we only consider invariance under cyclic groups. This allows for massive simplifications. This simplified version is comprehensibly set out in [2].
