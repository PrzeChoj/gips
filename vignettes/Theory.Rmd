...
It is worth to point out that constants $k = d$ for cyclic group $\Gamma = <\sigma>$ and that `gips` only considers cyclic groups. See example:
...
# Calculate the covariance matrix from the data (assume we know the mean is 0):
