...
$$AIC = 2 \cdot (\dim M) -2 \log L(\hat \Sigma)$$
$$BIC = (\log n) \cdot (\dim M) -2 \log L(\hat \Sigma)$$
...
$$AIC = 2 \cdot (\dim M) -2 \log L_{estimated\ mean}(\hat \Sigma)$$
$$BIC = (\log n) \cdot (\dim M) -2 \log L_{estimated\ mean}(\hat \Sigma)$$
