...
The package is based on the article [[1]](https://arxiv.org/abs/2004.03503.pdf). The math behind the package is precisely demonstrated, and all the theorems are proven.
...
2. $K$ given $\Gamma$ follows the Diaconis-Ylvisaker conjugate prior distribution with parameters $\delta$ (real number, $\delta > 0$) and $D$ (positive definite matrix of the same size as `S`), see [[1]](https://arxiv.org/abs/2004.03503.pdf), Sec. 3.4.
