...
The algorithm ends when all neighbors are less likely, or the `max_iter` was achieved. The algorithm will always end in a local maximum, but there is no guarantee that this is also the global maximum.
