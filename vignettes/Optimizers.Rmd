...
This is **only recommended** for small spaces ($p \le 9$). It can also browse bigger spaces, but the required time is probably too long. On our machines, for $p = 9$ the calculations takes around 5 hours. For $p = 10$ we expect around 40 hours of computations.
