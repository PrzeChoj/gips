...
The method is not scale-invariant and therefore we recommend to run gips for different values of `D_matrix` of the form `D_matrix = d * diag(p)`, where `d` $\in \mathbb{R}^+$).
