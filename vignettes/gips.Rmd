...
```
We see that assumption $(3,4,5)$ is the most likely with $19.7\%$ posterior probability. All other permutations are way less likely.

Remember that for the assumptions with transpositions (like $(3,5)$), the `n0` will be 4, which would be insufficient for us to estimate covariance correctly. The assumption $(3,4,5)$ will be just right:
