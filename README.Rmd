...
Keep in mind those calculations were performed on the `scale`d version of the dataset, so precticaly it was performed on the corelation matrix and not on the covariance matrix. The analysis is the same, but one have to remember to later come back to the original scaling:

```{r example_mean_unknown5}
