...
You can install the development version of gips from [GitHub](https://github.com/) with:
...
It is developed by Przemysław Chojecki and Paweł Morgen under the leadership of Ph.D. Bartosz Kołodziejek.
